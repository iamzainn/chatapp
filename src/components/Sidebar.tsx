...
const Sidebar = ({ isCollapsed, chats }: SidebarProps) => {
					...
					isCollapsed ? (
						...
						<Button
							...
							className={cn(
								...
								selectedChat?.user?.email===chat.user?.email &&
